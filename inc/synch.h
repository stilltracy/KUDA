...
bool islockedReentrant(ReentrantLock* lock);
...
// TODO: try to make a regular read from lock->lock
inline bool islockedReentrant(ReentrantLock* lock) {
	return (bool) READ(&lock->lock);
}
