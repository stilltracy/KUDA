...
# Includes
INCLUDES  += -I. -I$(CUDA_INSTALL_PATH)/include -I$(COMMONDIR)/inc -I$(COMMONDIR)/inc/dynlink -I/home/cbekar/Research/cudasdk/shared/inc -I$(JNIDIR)
...
ifneq ($(STATIC_LIB),)
	...
	SHAREDLIB = $(LINK) -shared -o lib$(EXECUTABLE).so $(OBJS) $(LIB) $(COMMONFLAGS) $(JAVAVM)
	JNILIB    = $(LINK) -dynamiclib -o lib$(EXECUTABLE).jnilib $(OBJS) $(LIB) $(COMMONFLAGS) $(JAVAVM) 
endif
...
shared: makedirectories $(OBJS) $(CUBINS) $(PTXBINS) Makefile
	$(VERBOSE)$(SHAREDLIB)

jnilib: makedirectories $(OBJS) $(CUBINS) $(PTXBINS) Makefile
	$(VERBOSE)$(JNILIB)
...
clean : tidy
	$(VERBOSE)rm -f *.stub.c *.gpu *.cu.cpp *.i *.ii *.so *.jnilib
